...
Route::post('pages/{page:id}/blocks/{block}/prototype', [BlockAiController::class, 'prototypePage'])->name('pages.blocks.prototype')->scopeBindings();
Route::resource('layouts.blocks', LayoutBlockController::class)->only(['create', 'store', 'edit', 'update', 'destroy'])->scoped(['layout' => 'id']);
Route::post('layouts/{layout:id}/blocks/{block}/prototype', [BlockAiController::class, 'prototypeLayout'])->name('layouts.blocks.prototype')->scopeBindings();
