        ...
        <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
                ...
                <h1 class="mt-6 text-balance text-4xl font-semibold tracking-tight text-slate-900 sm:text-5xl">
                    Dentistry that doesn't make you dread the chair
                </h1>

                <p class="mt-6 max-w-xl text-lg/8 text-slate-600">
                    We are a two-chair family practice on Fernwood Road. Same
                    dentist every visit, appointments that start on time, and a
                    written estimate before we pick up an instrument.
                </p>
            ...
            <img
                ...
                alt="A dentist talking with a patient in the Fernwood treatment room"
